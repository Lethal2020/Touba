<div class="about-us-area section-padding-100-0 bg-img bg-overlay" style="background-image: url(<?php echo base_url('ressources/img/bg-img/bg-4.jpg');?>);" id="about">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-heading">
                        <h2>Qui est Khadim Cisse ?</h2>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-thumbnail mb-100">
                        <img src="<?php echo base_url('ressources/img/bg-img/kha1.jpg');?>" alt="">
                    </div>
                </div>
                <!-- About Content -->
                <div class="col-12 col-lg-6">
                    <div class="about-content mb-100">
                        ...
                        <img src="<?php echo base_url('ressources/img/core-img/signature.png');?>" alt="">
                    </div>
                </div>
            </div>
        </div>
